    ...
    <Card>
      ...
      >
        <Form ref="form" :model="formAdd" :label-width="100" :rules="formValidate">
          ...
          <FormItem label="分类UK名称" prop="ukName">
            <Input v-model="formAdd.ukName" clearable style="width: 100%" />
          </FormItem>
          <FormItem label="分类MY名称" prop="myName">
            <Input v-model="formAdd.myName" clearable style="width: 100%" />
          </FormItem>
...
export default {
  ...
  methods: {
    ...
    edit(v) {
      ...
      this.formAdd.ukName = v.ukName;
      this.formAdd.myName = v.myName;
