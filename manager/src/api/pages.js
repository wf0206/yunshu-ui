...
//文章添加
export const saveWelcome = (params) => {
    return postRequest('/welcome/info/add', params, {"Content-Type": "application/json"})
}
//文章添加
export const saveBackground = (params) => {
    return postRequest('/background/info/add', params, {"Content-Type": "application/json"})
}
//文章修改
...
export const getWelcome = (params) => {
  return getRequest('/welcome/info', params)
}
//获取文章列表数据
export const getBackground = (params) => {
  return getRequest('/background/info', params)
}
