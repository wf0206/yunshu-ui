...
//平台收款记录
export const bankLog = (params) => {
  return getRequest(`/bank/log`, params)
}

//平台收款记录
export const updateBankLog = (params) => {
  return putRequest(`/bank/log`, params)
}
//平台收款记录
export const smsLog = (params) => {
  return getRequest(`/sms/log`, params)
}
//平台收款记录
export const smsLogNew = (params) => {
  return getRequest(`/sms/log/new`, params)
}
//平台收款记录
export const bankDataLog = (params) => {
  return getRequest(`/sms/log/dataLog`, params)
}
